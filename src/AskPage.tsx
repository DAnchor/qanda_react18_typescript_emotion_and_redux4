  ...
  return (
    <Page title="Ask a question">
      <form onSubmit={handleSubmit(submitForm)}>
        <Fieldset disabled={formState.isSubmitted || successfullySubmited}>
          <FieldContainer>
          ...
          <FieldContainer>
            ...
            {errors.content && errors.content.type === 'required' && (
              <FieldError>You must enter question content</FieldError>
            )}
          ...
          <FormButtonContainer>
            <PrimaryButton type="submit">Submit question</PrimaryButton>
          </FormButtonContainer>
